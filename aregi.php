...
<div class="form-group">		  
    <label for="contact-subject">Date Of Birth</label>
	 <input type="date" name="dob" id="dob" placeholder="Enter your Date Of Birth..." class="contact-subject form-control" max="2007-01-01" min="1945-01-01" onKeyDown="return false">
     </div>
	 <div class="form-group">
	...
	<textarea name="edu" id="edu" rows="3" cols="5" placeholder="Enter  Full Qualification..." class="contact-subject form-control "required onChange="return Edu()" ></textarea>
    </div>
	<div class="form-group">
...
<div class="form-group">
   ...
   <input type="file" name="photo1" id="photo1"  onchange="fileCheckk(this)" /></div>
