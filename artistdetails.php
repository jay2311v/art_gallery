...
<body>
 <!-- Top menu -->
    ...
    $qry="select * from aregistration where ureg='$c'";
...
?>
		...
		<div align="left">
			                    <div align="left">
			                    <div align="center"><div style="position:absolute;left:400px;top:280px;">
...
while($ar=mysqli_fetch_array($res))
{
	...
	$result2="SELECT * FROM aregistration where ureg='$ureg'";
