...
?>
       ...
       <form action="#" method="post" name="products">
        	<div class="img">
                    <span><img src="<?php echo $img ?>" height="200px" width="180px" style=" border-radius: 8px; " alt=""><span class="desc">
                    
                <div class="desc">
					
                    
   					 <input type="text"  id="txtbox" style="font-family:Copperplate Gothic Bold;font-size:21px;width:175px;" name="artistname" value='<?php echo $fname." ".$lname ?>'>
                 
				   <br><input type="hidden"  id="txtbox"  name="hiddenureg" value='<?php echo $ureg ?>'><br>
