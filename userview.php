...
<tr>
  ...
  <td></td><td><img src="ted.gif" style="position:absolute;right:200px;" width="350px" height="200px" alt="no image found"/></td></tr>
    ...
    <tr><td width="100" valign="top"><div align="left"><b><h5 style="color: #7C2816;" >FirstName:</h5></b></div></td>
  ...
  <tr>
    ...
    <td valign="top"><input type="text" size="50" readonly name="address"style="border-color:white;color:#7C2816;font-weight:bold" value='<?php echo $address ?> '></td>
  </tr>
  <tr>
